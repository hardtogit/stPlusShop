<template>
	<view class="container">
		...
		<view class="introduce-section" v-if="productInfo.goods.isFaceToFace != 1">
			...
			<view class="bot-row">
				<text>库存: {{productInfo.goods.stock==undefined?'':productInfo.goods.stock}}</text>
			</view>
		</view>
		...
		<view class="page-bottom">
			...
			<view class="action-btn-group">
				<button type="primary" class=" action-btn no-border buy-now-btn" @click="buy" v-if="productInfo.resources.status == 2">立即购买</button>
