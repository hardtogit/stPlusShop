...
/* harmony import */ var _index_vue_vue_type_template_id_2e6e94b8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.vue?vue&type=template&id=2e6e94b8& */ 38);
...

{
  ...
  methods: {
    ...
    /**
        ...
        * 分次请求未作整合
        */
    loadDataTop: function loadDataTop() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                data = {
                  data: JSON.stringify({
                    companyId: uni.getStorageSync('companyId'),
                    mini: "mini" }) };
                ...
                _this3.$getJson('/api/v2/vue/ydd/index/topResList.jsp', data, 'POST', function (res) {
    ...
    loadDataList: function loadDataList() {var _arguments = arguments,_this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var type, loading, url, data;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:type = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 'add';loading = _arguments.length > 1 ? _arguments[1] : undefined;if (!(

                type === 'add')) {_context2.next = 8;break;}if (!(
                _this4.loadingType === 'nomore')) {_context2.next = 5;break;}return _context2.abrupt("return");case 5:


                _this4.loadingType = 'loading';_context2.next = 9;break;case 8:

                _this4.loadingType = 'more';case 9:
                ...
                _this4.$getJson(url, data, 'POST', function (res) {
