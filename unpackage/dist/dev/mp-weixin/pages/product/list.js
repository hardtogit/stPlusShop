...
var _list = _interopRequireDefault(__webpack_require__(/*! ./pages/product/list.vue */ 136));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/* harmony import */ var _list_vue_vue_type_template_id_7f7dd002___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./list.vue?vue&type=template&id=7f7dd002& */ 137);
...
/* harmony import */ var _list_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./list.vue?vue&type=style&index=0&lang=scss& */ 141);
...

{
  ...
  methods: {
    //加载商品 ，带下拉刷新和上滑加载
    loadData: function loadData() {var _arguments = arguments,_this2 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var type, loading, data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:type = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : 'add';loading = _arguments.length > 1 ? _arguments[1] : undefined;if (!(

                type === 'add')) {_context.next = 8;break;}if (!(
                _this2.loadingType === 'nomore')) {_context.next = 5;break;}return _context.abrupt("return");case 5:


                _this2.loadingType = 'loading';_context.next = 10;break;case 8:

                _this2.loadingType = 'more';
                _this2.pageNumber = 1;case 10:


                data = {
                  data: JSON.stringify({
                    pageNumber: _this2.pageNumber,
                    likeTitle: _this2.likeTitle,
                    twoIndustryId: _this2.twoIndustryId }) };


                _this2.$getJson('/api/v2/vue/ydd/index/resList.jsp', data, 'POST', function (res) {
    ...
    loadIndustry: function loadIndustry() {var _this3 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:
                _this3.$getJson('/api/v2/vue/ydd/common/getIndustry.jsp', {}, 'POST', function (res) {
